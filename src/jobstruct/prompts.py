    ...
    extract = dedent("""
        ...
        <schema>
            ```json {{
                ...
                'pay_range': <>Return a list with the USD pay range of the position as numbers</>,
                'pay_unit': <>Return the best value from the set (annual, monthly, weekly, daily, hourly, other, unknown)</>,
